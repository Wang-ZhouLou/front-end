<template>
	...
	<div style="margin: -27px 0 0 400px;">
		...
		<el-button type="primary" size="mini" icon="el-icon-circle-plus-outline" style="width: 110px;" @click="dialogFormVisible = true">增加</el-button>
		<el-button type="primary" size="mini" icon="el-icon-delete">删除</el-button>
	</div>

	<div>
	<el-collapse :data="faqData" :key="item.label" v-model="activeNames" @change="handleChange" v-for="item in faqData" >
		<div>
	...
	<el-dialog title="新增FAQ信息" v-model="dialogFormVisible" class="di1">
		<el-form :model="form">
			...
			<el-input v-model="form.answer" autocomplete="off" style="width: 530px; margin: 0 0 0 120px;" type="textarea" :rows="9"></el-input>
		</el-form>
		<template #footer>
